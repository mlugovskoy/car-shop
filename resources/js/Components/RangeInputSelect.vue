...
<template>
    <div class="relative w-full md:w-72">
        ...
        <div class="flex flex-wrap md:flex-nowrap gap-4">
            <select
                class="border-2 w-full md:w-1/2 border-emerald-400 rounded-md text-gray-500 focus:border-emerald-400 text-sm focus:ring-blue-500 placeholder-emerald-400 block p-2.5"
